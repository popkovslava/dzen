<?php
namespace App\Services\GeoIp\geoip;
...
class SxGeo
{
    ...
    public function __construct($db_file = __DIR__ .'/SxGeo.dat', $type = SXGEO_FILE)
    {
    ...
    public function getNum($ip)
    {
        ...
        if ($this->memory_mode) {
            ...
            return $this->searchDb(fread($this->fh, $len * $this->block_len), $ipn, 0, $len);
        }
    }
    ...
    public function about()
    {
        ...
        $types   = array(
            'n/a', 'SxGeo Country', 'SxGeo City RU', 'SxGeo City EN', 'SxGeo City',
            'SxGeo City Max RU', 'SxGeo City Max EN', 'SxGeo City Max'
        );
        return array(
