...
<div class="wrapper" id="app">
    <div class="content">
        ...
        <div id="onepage-scroll-wrapper">
            ...
            @if(session()->has('ok'))
                <div class="after-parallax">
                    @include('sections/error', ['type' => 'success', 'message' => session('ok')])
                </div>
            @endif
            @if(isset($info))
                <div class="after-parallax">
                    @include('sections/error', ['type' => 'info', 'message' => $info])
                </div>
            @endif
        ...
        <div id="cookie-message" class="cookie-message js_msg hide">
            ...
            <p>
                By continuing to browse our site you agree to our use of cookies, revised <a href="privacy" target="_blank" rel="noopener"></a>.
                More information about <a href="http://www.allaboutcookies.org/" target="_blank" rel="noopener">cookies</a>
            </p>
